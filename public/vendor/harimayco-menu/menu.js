...
function addcustommenu() {
    ...
    var files = $('#custom-menu-item-image')[0].files[0];

    form_data.append('labelmenu', $('#custom-menu-item-name').val());
    form_data.append('linkmenu', $('#custom-menu-item-url').val());
    form_data.append('file', files);
    form_data.append('rolemenu', $('#custom-menu-item-role').val());
    form_data.append('idmenu', $('#idmenu').val());
