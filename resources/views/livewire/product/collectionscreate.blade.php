        ...
        <article class="full-width">
            <div class="columns customers-details-heading">
                <div class="page_header d-flex  align-item-center">
                    ...
                    <h4 class="mb-0 fw-5">Create collection</h4>
                </div>
            </div>
        </article>
    </section>
    ...
    <section class="full-width admin-body-width flex-wrap admin-full-width bd_none add-transfers-sec">
        <article class="full-width">
            <div class="columns two-thirds">
                <div class="card">
                    <label>Title</label>
                    <input type="text" name="title" placeholder="e.g. Summer collection, Under $100, Staff picks">
                    <div class="product-des-customize">
                        <label>Description (optional)</label>
                        <div class="product-des-customize-inner">
                      
                            <div class="product-dec-textbox">
                                <textarea class="form-control tinymce-editor {{ $errors->has('description') ? 'parsley-error' : '' }}" rows="5" placeholder="Please Enter descripation" name="description" id="descripation" wire:ignore.self>{{ old('description') }}</textarea>
            ...
            <div class="columns one-third right-details">
                <!-- <div class="card collection-avail-card">
                    <div class="card-top">
                        ...
                        <p class="mb-0">Will be available to 2 sales channels.</p>
                        <a href="#">select all</a>
                    </div>
                    <div class="row">
